...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个平凡的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fhsjoy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'YOU, 博客', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '1548006936', // 对应歌单的 id
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3K1Dbq7b3ASTVFbz', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3K1Dbq7b3ASTVFbz', // ck，在51la后台获取
